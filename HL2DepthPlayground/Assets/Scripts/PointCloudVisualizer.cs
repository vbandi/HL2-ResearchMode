...
namespace DefaultNamespace
{
    ...
    public class PointCloudVisualizer : MonoBehaviour
    {
        ...
        private void LoadSampleData()
        {
            ...
            Vector3 middlePoint = new Vector3(sampleParticleData[middleIndex], sampleParticleData[middleIndex + 1],
        ...
        public void CalculateQuad(Vector3 middlePoint)
        {
            ...
            var normal = CalculateNormal(middlePoint, _closestPoints.ToArray());
            DrawNormal(middlePoint, normal);

            Quad.position = middlePoint;
            Quad.LookAt(middlePoint - normal);
